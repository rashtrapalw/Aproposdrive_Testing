...
//           {/* RIGHT: circular orb */}
//           <div className="flex items-center justify-center pt-8 lg:pt-0 mt-10 lg:mt-0">
//             <div
...
//         maxWidth: 520,        /* confines the strip to roughly the left column width */
//         gap: '8px',
//       }}
//     >
//       {features.map((f, i) => (
...
//                 <div style={{ color: '#0d1b2a', flexShrink: 0 }}>
//                   {s.icon}
//                 </div>
//                 <div>
...
//           <div className="rounded-[2rem] p-8 mt-10 shadow-[0_20px_40px_rgba(0,0,0,0.08)] sm:p-10 lg:order-2" style={themeStyles.translucentCard}>
//             <img
...
//               {points.map((point) => (
//                 <li key={point} className="flex gap-4 rounded-3xl  shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition duration-300 hover:border-[#10B981] hover:bg-[#111827]" style={{ ...themeStyles.card, border: '1px solid rgba(255,255,255,0.08)' }}>
...
//           }}
//           className="flex flex-col gap-6 px-8 py-8 sm:flex-row sm:items-center sm:justify-between sm:px-10 sm:py-9"
//         >
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-10 mt-20">
        ...
        <div className="grid items-center gap-8 pt-16 pb-10 lg:grid-cols-2 lg:pt-20 lg:pb-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.7, ease: [0.21, 0.47, 0.32, 0.98], delay: 0.12 }}
          >
            <div
              className="relative flex items-center justify-center"
              style={{
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        ...
        >
          {pillars.map((p, i) => (
            <motion.div
              key={i}
              className="transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(0,0,0,0.1)]"
              style={{
                border: '1px solid #e2eaf2',
                borderRadius: 16,
                padding: '28px 18px',
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        ...
        >
          {stats.map((s, i) => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div className="transition-transform duration-300 hover:scale-110" style={{ color: '#0d1b2a', flexShrink: 0 }}>
                  {s.icon}
                </div>
                <div>
                  <p style={{ fontSize: 16, fontWeight: 700, color: '#0d1b2a', margin: 0, lineHeight: 1.3 }}>
