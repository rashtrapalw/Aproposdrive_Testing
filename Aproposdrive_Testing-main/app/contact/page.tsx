            ...
            >
              ...
              {/* <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  >
                    <span style={{ fontWeight: 900, fontSize: 22, color: c as string }}>{v}</span>
                    <span
                      style={{
                        fontSize: 10,
                        textTransform: 'uppercase',
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                          ...
                          <Input type="text" placeholder="Your name" required accent="#00a550" />
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                          <label style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.16em', color: 'rgba(13,27,42,0.55)' }}>
                            Email
                          </label>
                          <Input type="email" placeholder="you@email.com" required accent="#0077b6" />
                        </div>
                      </div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        ...
                        <Input type="tel" placeholder="+91 00000 00000" accent="#00a550" />
                      </div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        ...
                        <Input type="text" placeholder="How can we help?" required accent="#00a550" />
                      </div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        ...
                        <Input as="textarea" rows={4} placeholder="Tell us about your project..." required accent="#00a550" />
                      </div>
                      ...
                      <button
                        ...
                        onMouseEnter={(e) => (e.currentTarget.style.background = '#008f45')}
                        onMouseLeave={(e) => (e.currentTarget.style.background = '#00a550')}
                      >
                        Send Message <Send style={{ width: 15, height: 15 }} />
                      </button>
                    </motion.form>
                  )}
                </AnimatePresence>
