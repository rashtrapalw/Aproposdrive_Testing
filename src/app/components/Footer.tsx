        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8 w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
            ...
            >
              ...
              <p className="text-xs leading-relaxed max-w-[240px]" style={{ color: 'rgba(13,27,42,0.5)' }}>
                Powering Smarter Electric Mobility. Building sustainable and scalable EV powertrain solutions for a
                greener India.
              </p>
