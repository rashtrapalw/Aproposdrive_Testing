...
const milestones: Milestone[] = [
  ...
  },
  {
    ...
    points: [
      'Magnet free motor Technology - SRM for ceiling fans',
      'SRM & PMSM designs for BUS',
    ],
    icon: Award,
  },
  {
  ...
  },
  {
    ...
    points: [
      '200 SRM fan pilots & field operational',
      'MCU R&D: E-mobility',
      'PMSM mid motor designs EV2W',
    ],
    icon: Cpu,
  },
  {
  ...
  },
  {
    ...
    {
    year: '2026-27',
    title: 'Rare Earth Free Motor & Commercialization',
    points: [
      'Winner CII Ascend: Rare Earth Free Motor Pilot',
...
function MilestoneCard({ milestone, index }: { milestone: Milestone; index: number }) {
  ...
  {milestone.points.map((point, pi) => (
    ...
    >
      <span
        className="mt-[4px] flex-shrink-0 flex items-center justify-center rounded-full"
        style={{
          width: 10,
          height: 10,
          background: '#00a550',
